...
const resource = resources[28];
const relatedResources = [resources[27], resources[29], resources[30]];

const title = resource.title;
const date = "8 November 2023";
...
export const metadata = {
  title: title,
  description:
    "Master UGC content creation with proven ideas and strategies. Learn how to stay inspired, maintain consistency, and create high-quality content that engages your audience.",
  keywords: keywords,
  openGraph: {
    title: title,
    description:
